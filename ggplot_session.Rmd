...
```{r, echo = T, tidy = T}
source('C:/Users/itorre/PhD/programming/R programming/summarySE.R') 
...
Instead of using the summarySE function, you can create a summary data frame with tidyverse (thanks Frank!).
